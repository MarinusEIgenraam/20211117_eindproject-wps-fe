...
import { getOneProject, getProjectComments } from "../../../services/controllers/getRequests";
            ...
            <FormWindow>
                <ProjectHeader>
                    <Text>
                        ...
                        <Collaborators>Collaborators: { loadedProject?.collaborators.map((user)=> <span>{ user.username }</span>) }</Collaborators>
                            ...
                            loadedComments.map((comment) =>
                                (
                                    <li key={comment.id}>
                                        ...
                                        <footer><span>{comment.startTime}</span>{comment.user.username}</footer>
                                        <ul>
                                                ...
                                                comment.commentList.map((subComment) =>
                                                    (
                                                        <li key={subComment.id}>
                                                            ...
                                                            <footer><span>{subComment.startTime}</span>{subComment.user.username}</footer>
                                                        </li>
                                                    ))
                                            }
                                        </ul>
